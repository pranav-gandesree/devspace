...
//   console.log("your post is", postData);
...
//     console.log("data or media is", uploadData);
...
const updatePost = async (postData: any) => {
  ...
  try {
    ...
    // Parse tags from comma-separated string to array
    const tagArray = tags.split(',').map((tag: any) => tag.trim()).filter((tag: any) => tag !== '');
